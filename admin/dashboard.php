...
<?php
        include('connexion.php');
        $req_admin = $bdd->query("SELECT count(id_admin) as total_admin from admin");
        $admin = $req_admin->fetch();
        ?>
               <h4>Total Admin: <?php echo $admin['total_admin'] ?></h4>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total joueur</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
        include('connexion.php');
        $req_joueur = $bdd->query("SELECT count(id_joueur) as total_joueur from joueur");
        $joueur = $req_joueur->fetch();
        ?></div><?php echo $joueur['total_joueur'] ?>
            </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Toltal Compétition</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php
        include('connexion.php');
        $req = $bdd->query("SELECT count(id_competition) as total_competition from competition");
        $com = $req->fetch();
        ?></div><?php echo $com['total_competition'] ?></div>
   
                <div class="col">
                  <div class="progress progress-sm mr-2">
                    <div class="progress-bar bg-info" role="progressbar" style="width: 1%" aria-valuenow="50"
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Email</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
        include('connexion.php');
        $req = $bdd->query("SELECT count(id_msg) as total_email from email");
        $email = $req->fetch();
        ?></div><?php echo $email['total_email'] ?></div>
            <div class="col-auto">
