...
<?php 
include('connexion.php'); 
$id_admin= (isset($_GET['id_admin'])) ? (int) $_GET['id_admin'] : 0;
try
{
$result = $bdd->prepare('SELECT * FROM admin where admin.id_admin=? ');
$result->execute(array($id_admin));
$dl = $result->fetch()?> 
<form action="UpdateAdmin.php?id_admin=<?php echo $dl['id_admin']; ?>" method="POST">

        <div class="modal-body">

            <div class="form-group">
                <label> Nom </label>
                <input type="text" name="nom" class="form-control" value="<?php echo $dl['nom']; ?>">
            </div><div class="form-group">
                <label> Prenom </label>
                <input type="text" name="prenom" class="form-control" value="<?php echo $dl['prenom']; ?>">
            </div>
            <div class="form-group">
                <label>Image</label>
                <input type="file" name="image" class="form-control" value="<?php echo $dl['image']; ?>">
            </div>
            <div class="form-group">
                <label>Telephone</label>
                <input type="text" name="telephone" class="form-control" value="<?php echo $dl['telephone']; ?>">
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" class="form-control" value="<?php echo $dl['email']; ?>">
            </div>
            <div class="form-group">
                <label>Password</label>
                <input type="password" name="password" class="form-control" value="<?php echo $dl['password']; ?>">
            </div>
