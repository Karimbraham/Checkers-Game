...
try
{
$result = $bdd->prepare('SELECT * FROM competition where competition.id_competition=? ');
$result->execute(array($id_competition));
$dl = $result->fetch()?> 
<form action="UpdateCompetition.php?id_competition=<?php echo $dl['id_competition']; ?>" method="POST">

        <div class="modal-body">

           <div class="form-group">
                <label> Nb Competition </label>
                <input type="number" name="nb_competition" class="form-control" value="<?php echo $dl['nb_competition']; ?>">
            </div>
            <div class="form-group">
                <label>Date Competition</label>
                <input type="date" name="date_competition" class="form-control" value="<?php echo $dl['date_competition']; ?>">
            </div>
            <div class="form-group">
                <label>Gagnant</label>
                <input type="text" name="gagnant" class="form-control" value="<?php echo $dl['gagnant']; ?>">
            </div>
            <div class="form-group">
                <label>Looser</label>
                <input type="text" name="looser" class="form-control" value="<?php echo $dl['looser']; ?>">
            </div>
