...
<?php 
include('connexion.php'); 
$id_joueur= (isset($_GET['id_joueur'])) ? (int) $_GET['id_joueur'] : 0;
try
{
$result = $bdd->prepare('SELECT * FROM joueur where joueur.id_joueur=? ');
$result->execute(array($id_joueur));
$dl = $result->fetch()?> 
<form action="UpdateJoueur.php?id_joueur=<?php echo $dl['id_joueur']; ?>" method="POST">

        <div class="modal-body">

            <div class="form-group">
                <label> Username </label>
                <input type="text" name="username" class="form-control" value="<?php echo $dl['username']; ?>">
            </div><div class="form-group">
                <label> Nb_Competition </label>
